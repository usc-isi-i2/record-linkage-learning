...
public class FileSorter {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < args.length; i++) {
			...
			CSVWriter printer = new CSVWriter(new FileWriter(f));
			printer.writeAll(Arrays.asList(data));
			printer.flush();
			printer.close();
			
			System.out.println("Sorter successfully written " + data.length + " rows to out file");
